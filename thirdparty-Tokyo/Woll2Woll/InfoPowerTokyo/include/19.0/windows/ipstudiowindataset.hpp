...
// (DO NOT EDIT: machine generated header) 'ipstudiowindataset.dpk' rev: 32.00 (Windows)
...
#include <vcl.wwqbe.hpp>
#include <vcl.wwquery.hpp>
#include <vcl.wwstorep.hpp>
...
#include <Bde.DBTables.hpp>	// (bdertl)
