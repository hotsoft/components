...
type
  ...
  {$EXTERNALSYM TInternetAsyncResult}
  ...
  {$EXTERNALSYM TInternetPrefetchStatus}
...
function InternetCrackUrl(lpszUrl: PclChar; dwUrlLength, dwFlags: DWORD;
  var lpUrlComponents: TURLComponents): BOOL; stdcall;
  {$EXTERNALSYM InternetCrackUrl}

type
  TclInternetCrackUrl = function (lpszUrl: PclChar; dwUrlLength, dwFlags: DWORD;
    var lpUrlComponents: TURLComponents): BOOL; stdcall;
  {$EXTERNALSYM TclInternetCrackUrl}
...
function InternetCreateUrl(var lpUrlComponents: TURLComponents;
  dwFlags: DWORD; lpszUrl: PclChar; var dwUrlLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM InternetCreateUrl}

type
  TclInternetCreateUrl = function (var lpUrlComponents: TURLComponents;
    dwFlags: DWORD; lpszUrl: PclChar; var dwUrlLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetCreateUrl}
...
(*function InternetCanonicalizeUrl(lpszUrl: PclChar;
  lpszBuffer: PclChar; var lpdwBufferLength: DWORD;
  dwFlags: DWORD): BOOL; stdcall;
  {$EXTERNALSYM InternetCanonicalizeUrl}

type
  TclInternetCanonicalizeUrl = function (lpszUrl: PclChar; lpszBuffer: PclChar;
...
*)
function InternetCombineUrl(lpszBaseUrl, lpszRelativeUrl: PclChar;
  lpszBuffer: PclChar; var lpdwBufferLength: DWORD;
  dwFlags: DWORD): BOOL; stdcall;
  {$EXTERNALSYM InternetCombineUrl}

type
  TclInternetCombineUrl = function (lpszBaseUrl, lpszRelativeUrl: PclChar;
    lpszBuffer: PclChar; var lpdwBufferLength: DWORD; dwFlags: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetCombineUrl}
...
function InternetOpen(lpszAgent: PclChar; dwAccessType: DWORD;
  lpszProxy, lpszProxyBypass: PclChar; dwFlags: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM InternetOpen}

type
  TclInternetOpen = function (lpszAgent: PclChar; dwAccessType: DWORD;
    lpszProxy, lpszProxyBypass: PclChar; dwFlags: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM TclInternetOpen}
...
type
  ...
  {$EXTERNALSYM TclInternetCloseHandle}

function InternetConnect(hInet: HINTERNET; lpszServerName: PclChar;
  nServerPort: INTERNET_PORT; lpszUsername: PclChar; lpszPassword: PclChar;
  dwService: DWORD; dwFlags: DWORD; dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM InternetConnect}

type
  TclInternetConnect = function (hInet: HINTERNET; lpszServerName: PclChar;
    nServerPort: INTERNET_PORT; lpszUsername: PclChar; lpszPassword: PclChar;
    dwService: DWORD; dwFlags: DWORD; dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM TclInternetConnect}
...
function InternetOpenUrl(hInet: HINTERNET; lpszUrl: PclChar;
  lpszHeaders: PclChar; dwHeadersLength: DWORD; dwFlags: DWORD;
  dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM InternetOpenUrl}

type
  TclInternetOpenUrl = function (hInet: HINTERNET; lpszUrl: PclChar;
    lpszHeaders: PclChar; dwHeadersLength: DWORD; dwFlags: DWORD;
    dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM TclInternetOpenUrl}
...
type
  TclInternetReadFile = function (hFile: HINTERNET; lpBuffer: Pointer;
    dwNumberOfBytesToRead: DWORD; var lpdwNumberOfBytesRead: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetReadFile}
...
type
  TclInternetSetFilePointer = function (hFile: HINTERNET;
    lDistanceToMove: Longint; pReserved: Pointer;
    dwMoveMethod, dwContext: DWORD): DWORD; stdcall;
  {$EXTERNALSYM TclInternetSetFilePointer}
...
type
  ...
  {$EXTERNALSYM TclInternetWriteFile}
...
type
  ...
  {$EXTERNALSYM TclInternetFindNextFile}
...
type
  TclInternetQueryOption = function (hInet: HINTERNET; dwOption: DWORD;
    lpBuffer: Pointer; var lpdwBufferLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetQueryOption}
...
type
  ...
  lpBuffer: Pointer; dwBufferLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetSetOption}
...
function InternetGetLastResponseInfo(var lpdwError: DWORD; lpszBuffer: PclChar;
  var lpdwBufferLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM InternetGetLastResponseInfo}

type
  TclInternetGetLastResponseInfo = function (var lpdwError: DWORD; lpszBuffer: PclChar;
  var lpdwBufferLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetGetLastResponseInfo}
...
type
  TclInternetSetStatusCallback = function(hInet: HINTERNET;
    lpfnInternetCallback: PFNInternetStatusCallback): PFNInternetStatusCallback; stdcall;
  {$EXTERNALSYM TclInternetSetStatusCallback}
...
type
  ...
  var lpFindFileData: TWin32FindData; dwFlags: DWORD;
  dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM TclFtpFindFirstFile}
...
function FtpGetFile(hConnect: HINTERNET; lpszRemoteFile: PclChar;
  lpszNewFile: PclChar; fFailIfExists: BOOL; dwFlagsAndAttributes: DWORD;
  dwFlags: DWORD; dwContext: DWORD): BOOL stdcall;
...
function FtpPutFile(hConnect: HINTERNET; lpszLocalFile: PclChar;
  lpszNewRemoteFile: PclChar; dwFlags: DWORD; dwContext: DWORD): BOOL; stdcall;
...
function FtpDeleteFile(hConnect: HINTERNET; lpszFileName: PclChar): BOOL; stdcall;
  {$EXTERNALSYM FtpDeleteFile}

type
  TclFtpDeleteFile = function (hConnect: HINTERNET; lpszFileName: PclChar): BOOL; stdcall;
  {$EXTERNALSYM TclFtpDeleteFile}
...
function FtpRenameFile(hConnect: HINTERNET; lpszExisting: PclChar;
  lpszNew: PclChar): BOOL; stdcall;
...
function FtpOpenFile(hConnect: HINTERNET; lpszFileName: PclChar;
  dwAccess: DWORD; dwFlags: DWORD; dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM FtpOpenFile}

type
  TclFtpOpenFile = function (hConnect: HINTERNET; lpszFileName: PclChar;
  dwAccess: DWORD; dwFlags: DWORD; dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM TclFtpOpenFile}
...
function FtpCreateDirectory(hConnect: HINTERNET; lpszDirectory: PclChar): BOOL; stdcall;
  {$EXTERNALSYM FtpCreateDirectory}

type
  TclFtpCreateDirectory = function (hConnect: HINTERNET; lpszDirectory: PclChar): BOOL; stdcall;
  {$EXTERNALSYM TclFtpCreateDirectory}
...
function FtpRemoveDirectory(hConnect: HINTERNET; lpszDirectory: PclChar): BOOL; stdcall;
  {$EXTERNALSYM FtpRemoveDirectory}

type
  TclFtpRemoveDirectory = function (hConnect: HINTERNET; lpszDirectory: PclChar): BOOL; stdcall;
  {$EXTERNALSYM TclFtpRemoveDirectory}
...
function FtpSetCurrentDirectory(hConnect: HINTERNET; lpszDirectory: PclChar): BOOL; stdcall;
...
function FtpGetCurrentDirectory(hConnect: HINTERNET;
  lpszCurrentDirectory: PclChar; var lpdwCurrentDirectory: DWORD): BOOL; stdcall;
...
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PclChar; dwContext: DWORD): BOOL; stdcall;
...
(*function GopherCreateLocator(lpszHost: PclChar; nServerPort: INTERNET_PORT;
  lpszDisplayString: PclChar; lpszSelectorString: PclChar; dwGopherType: DWORD;
  lpszLocator: PclChar; var lpdwBufferLength: DWORD): BOOL; stdcall;
...
function GopherGetLocatorType(lpszLocator: PclChar;
...
function GopherFindFirstFile(hConnect: HINTERNET; lpszLocator: PclChar;
  lpszSearchString: PclChar; var lpFindData: TGopherFindData; dwFlags: DWORD;
  dwContext: DWORD): HINTERNET; stdcall;
...
function GopherOpenFile(hConnect: HINTERNET; lpszLocator: PclChar;
  lpszView: PclChar; dwFlags: DWORD; dwContext: DWORD): HINTERNET; stdcall;
...
(*function GopherGetAttribute(hConnect: HINTERNET; lpszLocator: PclChar;
  lpszAttributeName: PclChar; lpBuffer: Pointer; dwBufferLength: DWORD;
...
function HttpOpenRequest(hConnect: HINTERNET; lpszVerb: PclChar;
  lpszObjectName: PclChar; lpszVersion: PclChar; lpszReferrer: PclChar;
  lplpszAcceptTypes: PLPSTR; dwFlags: DWORD;
  dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM HttpOpenRequest}

type
  TclHttpOpenRequest = function (hConnect: HINTERNET; lpszVerb: PclChar;
  lpszObjectName: PclChar; lpszVersion: PclChar; lpszReferrer: PclChar;
  lplpszAcceptTypes: PLPSTR; dwFlags: DWORD;
  dwContext: DWORD): HINTERNET; stdcall;
  {$EXTERNALSYM TclHttpOpenRequest}
...
function HttpAddRequestHeaders(hRequest: HINTERNET; lpszHeaders: PclChar;
  dwHeadersLength: DWORD; dwModifiers: DWORD): BOOL; stdcall;
  {$EXTERNALSYM HttpAddRequestHeaders}

type
  TclHttpAddRequestHeaders = function (hRequest: HINTERNET; lpszHeaders: PclChar;
  dwHeadersLength: DWORD; dwModifiers: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclHttpAddRequestHeaders}
...
function HttpSendRequest(hRequest: HINTERNET; lpszHeaders: PclChar;
  dwHeadersLength: DWORD; lpOptional: Pointer; 
  dwOptionalLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM HttpSendRequest}

type
  TclHttpSendRequest = function (hRequest: HINTERNET; lpszHeaders: PclChar;
  dwHeadersLength: DWORD; lpOptional: Pointer;
  dwOptionalLength: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclHttpSendRequest}
...
type
  TclHttpSendRequestEx = function (hRequest: HINTERNET; lpBuffersIn: PInternetBuffers;
    lpBuffersOut: PInternetBuffers;
    dwFlags: DWORD; dwContext: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclHttpSendRequestEx}
...
function InternetGetCookie(lpszUrl, lpszCookieName,
  lpszCookieData: PclChar; var lpdwSize: DWORD): BOOL; stdcall;
  {$EXTERNALSYM InternetGetCookie}

type
  TclInternetGetCookie = function (lpszUrl, lpszCookieName,
  lpszCookieData: PclChar; var lpdwSize: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetGetCookie}
...
type
  ...
  dwError, dwFlags: DWORD; var lppvData: Pointer): DWORD; stdcall;
  {$EXTERNALSYM TclInternetErrorDlg}
...
(*function CreateUrlCacheEntry(lpszUrlName: PAnsiChar;
  ...
  lpszFileName: PclChar; dwReserved: DWORD): BOOL; stdcall;
...
function CommitUrlCacheEntry(lpszUrlName, lpszLocalFileName: PAnsiChar;
  ...
  lpHeaderInfo: PBYTE; dwHeaderSize: DWORD; lpszFileExtension: PclChar;
  dwReserved: DWORD): BOOL; stdcall;
...
*)
function RetrieveUrlCacheEntryStream(lpszUrlName: PclChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
...
type
  TclRetrieveUrlCacheEntryStream = function (lpszUrlName: PclChar;
    var lpCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL;
    dwReserved: DWORD): THandle; stdcall;
  {$EXTERNALSYM TclRetrieveUrlCacheEntryStream}
...
type
  TclReadUrlCacheEntryStream = function (hUrlCacheStream: THandle;
    dwLocation: DWORD; lpBuffer: Pointer;
    var lpdwLen: DWORD; Reserved: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclReadUrlCacheEntryStream}
...
type
  TclUnlockUrlCacheEntryStream = function (hUrlCacheStream: THandle;
    Reserved: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclUnlockUrlCacheEntryStream}

function GetUrlCacheEntryInfo(lpszUrlName: PclChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
  var lpdwCacheEntryInfoBufferSize: DWORD): BOOL; stdcall;
  {$EXTERNALSYM GetUrlCacheEntryInfo}

type
  TclGetUrlCacheEntryInfo = function (lpszUrlName: PclChar;
    var lpCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwCacheEntryInfoBufferSize: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclGetUrlCacheEntryInfo}
...
(*function SetUrlCacheEntryGroup(lpszUrlName: LPCSTR; dwFlags: DWORD;
  GroupId: Int64;
  pbGroupAttributes: PclChar; { must pass nil }
...
*)
function FindFirstUrlCacheEntry(lpszUrlSearchPattern: PclChar;
...
type
  TclFindFirstUrlCacheEntry = function (lpszUrlSearchPattern: PclChar;
    var lpFirstCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwFirstCacheEntryInfoBufferSize: DWORD): THandle; stdcall;
  {$EXTERNALSYM TclFindFirstUrlCacheEntry}
...
type
  TclFindNextUrlCacheEntry = function (hEnumHandle: THandle;
    var lpNextCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwNextCacheEntryInfoBufferSize: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclFindNextUrlCacheEntry}
...
type
  ...
  {$EXTERNALSYM TclFindCloseUrlCache}
...
type
  ...
  {$EXTERNALSYM TclDeleteUrlCacheEntry}
...
type
  TclInternetGetConnectedState = function (lpdwFlags: LPDWORD; dwReserved: DWORD): BOOL; stdcall;
  {$EXTERNALSYM TclInternetGetConnectedState}
...
//  clInternetCanonicalizeUrl: TclInternetCanonicalizeUrl;
  ...
  clInternetGetConnectedState: TclInternetGetConnectedState;
...
begin
  @clInternetCrackUrl := clGetProcAddress(WinInetModule, 'InternetCrackUrlA', False);
  @clInternetCreateUrl := clGetProcAddress(WinInetModule, 'InternetCreateUrlA', False);
//  @clInternetCanonicalizeUrl := clGetProcAddress(WinInetModule, 'InternetCanonicalizeUrlA', False);
  @clInternetCombineUrl := clGetProcAddress(WinInetModule, 'InternetCombineUrlA', False);
  @clInternetOpen := clGetProcAddress(WinInetModule, 'InternetOpenA', False);
  @clInternetCloseHandle := clGetProcAddress(WinInetModule, 'InternetCloseHandle', False);
  @clInternetConnect := clGetProcAddress(WinInetModule, 'InternetConnectA', False);
  @clInternetOpenUrl := clGetProcAddress(WinInetModule, 'InternetOpenUrlA', False);
  @clInternetReadFile := clGetProcAddress(WinInetModule, 'InternetReadFile', False);
  @clInternetQueryOption := clGetProcAddress(WinInetModule, 'InternetQueryOptionA', False);
  @clInternetSetOption := clGetProcAddress(WinInetModule, 'InternetSetOptionA', False);
  @clInternetGetLastResponseInfo := clGetProcAddress(WinInetModule, 'InternetGetLastResponseInfoA', False);
{$IFDEF DELPHI2009}
  @clFtpFindFirstFile := clGetProcAddress(WinInetModule, 'FtpFindFirstFileW', False);
  @clInternetFindNextFile := clGetProcAddress(WinInetModule, 'InternetFindNextFileW', False);
{$ELSE}
  @clFtpFindFirstFile := clGetProcAddress(WinInetModule, 'FtpFindFirstFileA', False);
  @clInternetFindNextFile := clGetProcAddress(WinInetModule, 'InternetFindNextFileA', False);
{$ENDIF}
  @clFtpOpenFile := clGetProcAddress(WinInetModule, 'FtpOpenFileA', False);
  @clFtpCreateDirectory := clGetProcAddress(WinInetModule, 'FtpCreateDirectoryA', False);
  @clFtpRemoveDirectory := clGetProcAddress(WinInetModule, 'FtpRemoveDirectoryA', False);
  @clFtpGetFileSize := clGetProcAddress(WinInetModule, 'FtpGetFileSize', True);
  @clHttpOpenRequest := clGetProcAddress(WinInetModule, 'HttpOpenRequestA', False);
  @clHttpAddRequestHeaders := clGetProcAddress(WinInetModule, 'HttpAddRequestHeadersA', False);
  @clHttpSendRequest := clGetProcAddress(WinInetModule, 'HttpSendRequestA', False);
  @clHttpSendRequestEx := clGetProcAddress(WinInetModule, 'HttpSendRequestExA', False);
  @clHttpEndRequest := clGetProcAddress(WinInetModule, 'HttpEndRequestA', False);
  @clHttpQueryInfo := clGetProcAddress(WinInetModule, 'HttpQueryInfoA', False);
  @clInternetErrorDlg := clGetProcAddress(WinInetModule, 'InternetErrorDlg', False);
  @clInternetWriteFile := clGetProcAddress(WinInetModule, 'InternetWriteFile', False);
  @clInternetSetFilePointer := clGetProcAddress(WinInetModule, 'InternetSetFilePointer', False);
  @clFtpDeleteFile := clGetProcAddress(WinInetModule, 'FtpDeleteFileA', False);
  @clInternetGetCookie := clGetProcAddress(WinInetModule, 'InternetGetCookieA', False);
  @clInternetSetCookie := clGetProcAddress(WinInetModule, 'InternetSetCookieA', False);
  @clInternetSetStatusCallback := clGetProcAddress(WinInetModule, 'InternetSetStatusCallback', False);
  @clFindFirstUrlCacheEntry := clGetProcAddress(WinInetModule, 'FindFirstUrlCacheEntryA', False);
  @clGetUrlCacheEntryInfo := clGetProcAddress(WinInetModule, 'GetUrlCacheEntryInfoA', False);
  @clRetrieveUrlCacheEntryStream := clGetProcAddress(WinInetModule, 'RetrieveUrlCacheEntryStreamA', False);
  @clReadUrlCacheEntryStream := clGetProcAddress(WinInetModule, 'ReadUrlCacheEntryStream', False);
  @clUnlockUrlCacheEntryStream := clGetProcAddress(WinInetModule, 'UnlockUrlCacheEntryStream', False);
  @clFindNextUrlCacheEntry := clGetProcAddress(WinInetModule, 'FindNextUrlCacheEntryA', False);
  @clFindCloseUrlCache := clGetProcAddress(WinInetModule, 'FindCloseUrlCache', False);
  @clDeleteUrlCacheEntry := clGetProcAddress(WinInetModule, 'DeleteUrlCacheEntry', False);
  @clInternetGetConnectedState := clGetProcAddress(WinInetModule, 'InternetGetConnectedState', False);
end;
...
(*function InternetCanonicalizeUrl(lpszUrl: PclChar; lpszBuffer: PclChar;
  var lpdwBufferLength: DWORD; dwFlags: DWORD): BOOL; stdcall;
begin
  InitWinInet();
...
begin
  Result := 0;
  InitWinInet();
  if Assigned(clFtpGetFileSize) then
  begin
...
begin
  InitWinInet();
  Result := clInternetGetConnectedState(lpdwFlags, dwReserved);
end;
