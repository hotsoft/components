...
//+-------------------------------------------------------------------------
//  Certificate Key Usage constants
//--------------------------------------------------------------------------
const
...
Const
  ...
  {$EXTERNALSYM ALD_SID_SAFERSK128}
...
const
  ...
  {$EXTERNALSYM CRYPT_SSL2_SLUMMING}
  ...
  //CryptDecrypt/CryptEncrypt flags
...
{$ENDIF}
  ...
  // Provider friendly names        'Microsoft Enhanced RSA and AES Cryptographic Provider (Prototype)' for Win XP
...
type
  ...
  PROV_ENUMALGS = record
    ...
    dwBitLen  :DWORD;
    dwNameLen :DWORD;
    szName    :array[0..20-1] of TclChar;
  end ;
...
type
  ...
  PROV_ENUMALGS_EX = record
    ...
    szName        :array[0..20-1] of TclChar;
    dwLongNameLen :DWORD;
    szLongName    :array[0..40-1] of TclChar;
    end;
...
type
  HCRYPTPROV  = Pointer; //ULONG_PTR
  PHCRYPTPROV = ^HCRYPTPROV;
  HCRYPTKEY   = Pointer; //ULONG_PTR
  PHCRYPTKEY  = ^HCRYPTKEY;
  HCRYPTHASH  = Pointer; //ULONG_PTR
...
type
  TclCryptDeriveKey = function(hProv     :HCRYPTPROV;
                        Algid     :ALG_ID;
                        hBaseData :HCRYPTHASH;
                        dwFlags   :DWORD;
                        phKey     :PHCRYPTKEY) :BOOL;stdcall;
...
type
  TclCryptSetKeyParam = function(hKey    :HCRYPTKEY;
                          dwParam :DWORD;
                          pbData  :PBYTE;
                          dwFlags :DWORD) :BOOL;stdcall;
...
type
  TclCryptGetKeyParam = function (hKey       :HCRYPTKEY;
                          dwParam    :DWORD;
                          pbData     :PBYTE;
                          pdwDataLen :PDWORD;
                          dwFlags    :DWORD) :BOOL;stdcall;
...
type
  TclCryptGenRandom = function(hProv    :HCRYPTPROV;
                        dwLen    :DWORD;
                        pbBuffer :PBYTE) :BOOL;stdcall;
...
type
  TclCryptHashSessionKey = function (hHash   :HCRYPTHASH;
                             hKey    :HCRYPTKEY;
                             dwFlags :DWORD) :BOOL;stdcall;
...
type
  TclCryptEncodeObject = function (dwCertEncodingType :DWORD;
                           lpszStructType     :LPCSTR;
                     const pvStructInfo       :PVOID;
                           pbEncoded          :PBYTE;
                           pcbEncoded         :PDWORD ):BOOL ; stdcall;

function CryptEncodeObjectEx(dwCertEncodingType :DWORD;
                           lpszStructType     :LPCSTR;
                           pvStructInfo       :PVOID;
                           dwFlags            :DWORD;
                           pEncodePara        :PVOID;
...
type
  TclCryptEncodeObjectEx = function (dwCertEncodingType :DWORD;
                           lpszStructType     :LPCSTR;
                           pvStructInfo       :PVOID;
                           dwFlags            :DWORD;
                           pEncodePara        :PVOID;
...
type
  TclCryptDecodeObjectEx = function (dwCertEncodingType: DWORD;
                           lpszStructType     :LPCSTR;
                     const pbEncoded: PBYTE;
                           cbEncoded: DWORD;
                           dwFlags: DWORD;
...
type
  TclCryptFindOIDInfo = function (dwKeyType :DWORD;
                          pvKey :PVOID;
                          dwGroupId :DWORD):PCCRYPT_OID_INFO ; stdcall;
...
type
  TclCertGetEnhancedKeyUsage = function (pCertContext :PCCERT_CONTEXT;
                                 dwFlags :DWORD;
                                 pUsage :PCERT_ENHKEY_USAGE;
                                 pcbUsage :PDWORD):BOOL ; stdcall;
...
type
  TclCertSetEnhancedKeyUsage = function (pCertContext :PCCERT_CONTEXT;
                                 pUsage :PCERT_ENHKEY_USAGE
                                 ):BOOL ; stdcall;
...
type
  TclCryptVerifyCertificateSignature = function (hCryptProv :HCRYPTPROV;
                                           dwCertEncodingType :DWORD;
                                     const pbEncoded :PBYTE;
                                           cbEncoded :DWORD;
                                           pPublicKey :PCERT_PUBLIC_KEY_INFO
...
const
  ...
  CERT_CHAIN_POLICY_BASE              = PclChar(1);
  {$EXTERNALSYM CERT_CHAIN_POLICY_BASE}
  CERT_CHAIN_POLICY_AUTHENTICODE      = PclChar(2);
  {$EXTERNALSYM CERT_CHAIN_POLICY_AUTHENTICODE}
  CERT_CHAIN_POLICY_AUTHENTICODE_TS   = PclChar(3);
  {$EXTERNALSYM CERT_CHAIN_POLICY_AUTHENTICODE_TS}
  CERT_CHAIN_POLICY_SSL               = PclChar(4);
  {$EXTERNALSYM CERT_CHAIN_POLICY_SSL}
  CERT_CHAIN_POLICY_BASIC_CONSTRAINTS = PclChar(5);
  {$EXTERNALSYM CERT_CHAIN_POLICY_BASIC_CONSTRAINTS}
  CERT_CHAIN_POLICY_NT_AUTH           = PclChar(6);
...
{$EXTERNALSYM TclCryptSignAndEncryptMessage}
//+-------------------------------------------------------------------------
...
var
  ...
  clCryptDecodeObjectEx: TclCryptDecodeObjectEx;
  clCryptEncodeObject: TclCryptEncodeObject;
  clCryptEncodeObjectEx: TclCryptEncodeObjectEx;
  ...
  clCryptGenRandom: TclCryptGenRandom;
  ...
  clCryptHashSessionKey: TclCryptHashSessionKey;
  clCryptDeriveKey: TclCryptDeriveKey;
  clCryptDestroyKey: TclCryptDestroyKey;
  clCryptSetKeyParam: TclCryptSetKeyParam;
  clCryptGetKeyParam: TclCryptGetKeyParam;
  ...
  clCryptVerifyCertificateSignature: TclCryptVerifyCertificateSignature;
  clCryptGenKey: TclCryptGenKey;
  clCryptFindOIDInfo: TclCryptFindOIDInfo;
  clCertGetEnhancedKeyUsage: TclCertGetEnhancedKeyUsage;
  clCertSetEnhancedKeyUsage: TclCertSetEnhancedKeyUsage;
...
begin
  ...
  if not Assigned(clCryptAcquireContext) then
    @clCryptAcquireContext := clGetProcAddress(ADVAPIModule, 'CryptAcquireContextA', False);
...
begin
  ...
  if not Assigned(clCryptReleaseContext) then
    @clCryptReleaseContext := clGetProcAddress(ADVAPIModule, 'CryptReleaseContext', False);
...
begin
  ...
  if not Assigned(clCryptAcquireCertificatePrivateKey) then
    @clCryptAcquireCertificatePrivateKey := clGetProcAddress(CryptModule, 'CryptAcquireCertificatePrivateKey', False); //xp 2000 nt, redist for 98
...
begin
  InitCrypt();
  if not Assigned(clCryptGenRandom) then
    @clCryptGenRandom := clGetProcAddress(ADVAPIModule, 'CryptGenRandom', False);

  Result := clCryptGenRandom(hProv, dwLen, pbBuffer);
end;
...
begin
  ...
  if not Assigned(clCryptGetUserKey) then
    @clCryptGetUserKey := clGetProcAddress(ADVAPIModule, 'CryptGetUserKey', False);
...
begin
  ...
  if not Assigned(clCryptGetProvParam) then
    @clCryptGetProvParam := clGetProcAddress(ADVAPIModule, 'CryptGetProvParam', False);
...
begin
  ...
  if not Assigned(clCryptExportKey) then
    @clCryptExportKey := clGetProcAddress(ADVAPIModule, 'CryptExportKey', False);
...
begin
  ...
  if not Assigned(clCryptImportKey) then
    @clCryptImportKey := clGetProcAddress(ADVAPIModule, 'CryptImportKey', False);
...
begin
  ...
  if not Assigned(clCryptDecrypt) then
    @clCryptDecrypt := clGetProcAddress(ADVAPIModule, 'CryptDecrypt', False);
...
begin
  ...
  if not Assigned(clCryptEncrypt) then
    @clCryptEncrypt := clGetProcAddress(ADVAPIModule, 'CryptEncrypt', False);
...
begin
  ...
  if not Assigned(clCryptCreateHash) then
    @clCryptCreateHash := clGetProcAddress(ADVAPIModule, 'CryptCreateHash', False);
...
begin
  ...
  if not Assigned(clCryptHashData) then
    @clCryptHashData := clGetProcAddress(ADVAPIModule, 'CryptHashData', False);
...
begin
  ...
  if not Assigned(clCryptDestroyHash) then
    @clCryptDestroyHash := clGetProcAddress(ADVAPIModule, 'CryptDestroyHash', False);
...
begin
  InitCrypt();
  if not Assigned(clCryptHashSessionKey) then
    @clCryptHashSessionKey := clGetProcAddress(ADVAPIModule, 'CryptHashSessionKey', False);

  Result := clCryptHashSessionKey(hHash, hKey, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptDeriveKey) then
    @clCryptDeriveKey := clGetProcAddress(ADVAPIModule, 'CryptDeriveKey', False);

  Result := clCryptDeriveKey(hProv, Algid, hBaseData, dwFlags, phKey);
end;
...
begin
  ...
  if not Assigned(clCryptDestroyKey) then
    @clCryptDestroyKey := clGetProcAddress(ADVAPIModule, 'CryptDestroyKey', False);
...
begin
  InitCrypt();
  if not Assigned(clCryptSetKeyParam) then
    @clCryptSetKeyParam := clGetProcAddress(ADVAPIModule, 'CryptSetKeyParam', False);

  Result := clCryptSetKeyParam(hKey, dwParam, pbData, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptGetKeyParam) then
    @clCryptGetKeyParam := clGetProcAddress(ADVAPIModule, 'CryptGetKeyParam', False);

  Result := clCryptGetKeyParam(hKey, dwParam, pbData, pdwDataLen, dwFlags);
end;
...
begin
  ...
  if not Assigned(clCryptSetHashParam) then
    @clCryptSetHashParam := clGetProcAddress(ADVAPIModule, 'CryptSetHashParam', False);
...
begin
  ...
  if not Assigned(clCryptGetHashParam) then
    @clCryptGetHashParam := clGetProcAddress(ADVAPIModule, 'CryptGetHashParam', False);
...
begin
  ...
  if not Assigned(clCryptSignHash) then
    @clCryptSignHash := clGetProcAddress(ADVAPIModule, 'CryptSignHashA', False);
...
begin
  ...
  if not Assigned(clCryptVerifySignature) then
    @clCryptVerifySignature := clGetProcAddress(ADVAPIModule, 'CryptVerifySignatureA', False);
...
begin
  ...
  if not Assigned(clCryptGetDefaultProvider) then
    @clCryptGetDefaultProvider := clGetProcAddress(ADVAPIModule, 'CryptGetDefaultProviderA', False);
...
begin
  ...
  if not Assigned(clCryptEnumProviderTypes) then
    @clCryptEnumProviderTypes := clGetProcAddress(ADVAPIModule, 'CryptEnumProviderTypesA', False);
...
begin
  ...
  if not Assigned(clCryptEnumProviders) then
    @clCryptEnumProviders := clGetProcAddress(ADVAPIModule, 'CryptEnumProvidersA', False);
...
begin
  ...
  if not Assigned(clCertFindCertificateInStore) then
    @clCertFindCertificateInStore := clGetProcAddress(CryptModule, 'CertFindCertificateInStore', False);
...
begin
  ...
  if not Assigned(clCertEnumCertificatesInStore) then
    @clCertEnumCertificatesInStore := clGetProcAddress(CryptModule, 'CertEnumCertificatesInStore', False);
...
begin
  ...
  if not Assigned(clCertCreateCertificateContext) then
    @clCertCreateCertificateContext := clGetProcAddress(CryptModule, 'CertCreateCertificateContext', False);
...
begin
  ...
  if not Assigned(clCertFreeCertificateContext) then
    @clCertFreeCertificateContext := clGetProcAddress(CryptModule, 'CertFreeCertificateContext', False);
...
begin
  ...
  if not Assigned(clCertDuplicateCertificateContext) then
    @clCertDuplicateCertificateContext := clGetProcAddress(CryptModule, 'CertDuplicateCertificateContext', False);
...
begin
  ...
  if not Assigned(clCryptDecodeObject) then
    @clCryptDecodeObject := clGetProcAddress(CryptModule, 'CryptDecodeObject', False);
...
begin
  InitCrypt();
  if not Assigned(clCryptDecodeObjectEx) then
    @clCryptDecodeObjectEx := clGetProcAddress(CryptModule, 'CryptDecodeObjectEx', False);

  Result := clCryptDecodeObjectEx(dwCertEncodingType, lpszStructType, pbEncoded, cbEncoded,
...
begin
  InitCrypt();
  if not Assigned(clCryptEncodeObject) then
    @clCryptEncodeObject := clGetProcAddress(CryptModule, 'CryptEncodeObject', False);

  Result := clCryptEncodeObject(dwCertEncodingType, lpszStructType, pvStructInfo, pbEncoded, pcbEncoded);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptEncodeObjectEx) then
    @clCryptEncodeObjectEx := clGetProcAddress(CryptModule, 'CryptEncodeObjectEx', False);

  Result := clCryptEncodeObjectEx(dwCertEncodingType, lpszStructType, pvStructInfo, dwFlags, pEncodePara, pvEncoded, pcbEncoded);
end;
...
begin
  ...
  if not Assigned(clCertGetCertificateChain) then
    @clCertGetCertificateChain := clGetProcAddress(CryptModule, 'CertGetCertificateChain', False); //xp 2000 nt, redist for 98
...
begin
  ...
  if not Assigned(clCertVerifyCertificateChainPolicy) then
    @clCertVerifyCertificateChainPolicy := clGetProcAddress(CryptModule, 'CertVerifyCertificateChainPolicy', False); //xp 2000 nt, redist for 98
...
begin
  ...
  if not Assigned(clCertFreeCertificateChain) then
    @clCertFreeCertificateChain := clGetProcAddress(CryptModule, 'CertFreeCertificateChain', False);//xp 2000 nt, redist for 98
...
begin
  ...
  if not Assigned(clCertFindExtension) then
    @clCertFindExtension := clGetProcAddress(CryptModule, 'CertFindExtension', False);
...
begin
  ...
  if not Assigned(clCryptImportPublicKeyInfoEx) then
    @clCryptImportPublicKeyInfoEx := clGetProcAddress(CryptModule, 'CryptImportPublicKeyInfoEx', False);
...
begin
  ...
  if not Assigned(clCryptEncryptMessage) then
    @clCryptEncryptMessage := clGetProcAddress(CryptModule, 'CryptEncryptMessage', False);
...
begin
  ...
  if not Assigned(clCryptDecryptMessage) then
    @clCryptDecryptMessage := clGetProcAddress(CryptModule, 'CryptDecryptMessage', False);
...
begin
  ...
  if not Assigned(clCertOpenSystemStore) then
    @clCertOpenSystemStore := clGetProcAddress(CryptModule, 'CertOpenSystemStoreA', False);
...
begin
  ...
  if not Assigned(clCertOpenStore) then
    @clCertOpenStore := clGetProcAddress(CryptModule, 'CertOpenStore', False);
...
begin
  ...
  if not Assigned(clCertCloseStore) then
    @clCertCloseStore  := clGetProcAddress(CryptModule, 'CertCloseStore', False);
...
begin
  ...
  if not Assigned(clCryptSignAndEncryptMessage) then
    @clCryptSignAndEncryptMessage := clGetProcAddress(CryptModule, 'CryptSignAndEncryptMessage', False);
...
begin
  ...
  if not Assigned(clCryptVerifyDetachedMessageSignature) then
    @clCryptVerifyDetachedMessageSignature := clGetProcAddress(CryptModule, 'CryptVerifyDetachedMessageSignature', False);
...
begin
  ...
  if not Assigned(clCryptGetMessageCertificates) then
    @clCryptGetMessageCertificates := clGetProcAddress(CryptModule, 'CryptGetMessageCertificates', False);
...
begin
  ...
  if not Assigned(clCryptVerifyMessageSignature) then
    @clCryptVerifyMessageSignature := clGetProcAddress(CryptModule, 'CryptVerifyMessageSignature', False);
...
begin
  ...
  if not Assigned(clCryptSignMessage) then
    @clCryptSignMessage := clGetProcAddress(CryptModule, 'CryptSignMessage', False);
...
begin
  ...
  if not Assigned(clCertNameToStr) then
    @clCertNameToStr := clGetProcAddress(CryptModule, 'CertNameToStrW', False);

  if Assigned(clCertNameToStr) then
  begin
...
begin
  ...
  if not Assigned(clCertGetNameString) then
    @clCertGetNameString := clGetProcAddress(CryptModule, 'CertGetNameStringW', True);

  if Assigned(clCertGetNameString) then
  begin
...
begin
  ...
  if not Assigned(clCertDeleteCertificateFromStore) then
    @clCertDeleteCertificateFromStore := clGetProcAddress(CryptModule, 'CertDeleteCertificateFromStore', False);
...
begin
  ...
  if not Assigned(clCertGetSubjectCertificateFromStore) then
    @clCertGetSubjectCertificateFromStore := clGetProcAddress(CryptModule, 'CertGetSubjectCertificateFromStore', False);
...
begin
  ...
  if not Assigned(clCertAddCertificateContextToStore) then
    @clCertAddCertificateContextToStore := clGetProcAddress(CryptModule, 'CertAddCertificateContextToStore', False);
...
begin
  ...
  if not Assigned(clPFXImportCertStore) then
    @clPFXImportCertStore := clGetProcAddress(CryptModule, 'PFXImportCertStore', False); //xp 2000
...
begin
  ...
  if not Assigned(clPFXExportCertStoreEx) then
    @clPFXExportCertStoreEx := clGetProcAddress(CryptModule, 'PFXExportCertStoreEx', False); //xp 2000
...
begin
  ...
  if not Assigned(clCertStrToName) then
    @clCertStrToName := clGetProcAddress(CryptModule, 'CertStrToNameW', False);
...
begin
  ...
  if not Assigned(clCryptExportPublicKeyInfo) then
    @clCryptExportPublicKeyInfo := clGetProcAddress(CryptModule, 'CryptExportPublicKeyInfo', False);
...
begin
  ...
  if not Assigned(clCryptSignAndEncodeCertificate) then
    @clCryptSignAndEncodeCertificate := clGetProcAddress(CryptModule, 'CryptSignAndEncodeCertificate', False);
...
begin
  InitCrypt();
  if not Assigned(clCryptVerifyCertificateSignature) then
    @clCryptVerifyCertificateSignature := clGetProcAddress(CryptModule, 'CryptVerifyCertificateSignature', False);

  Result := clCryptVerifyCertificateSignature(hCryptProv, dwCertEncodingType, pbEncoded, cbEncoded, pPublicKey);
end;
...
begin
  ...
  if not Assigned(clCryptGenKey) then
    @clCryptGenKey := clGetProcAddress(ADVAPIModule, 'CryptGenKey', False);
...
begin
  ...
  if not Assigned(clCertSetCertificateContextProperty) then
    @clCertSetCertificateContextProperty := clGetProcAddress(CryptModule, 'CertSetCertificateContextProperty', False);
...
begin
  ...
  if not Assigned(clCertGetCertificateContextProperty) then
    @clCertGetCertificateContextProperty := clGetProcAddress(CryptModule, 'CertGetCertificateContextProperty', False);
...
begin
  ...
  if not Assigned(clCertEnumCertificateContextProperties) then
    @clCertEnumCertificateContextProperties := clGetProcAddress(CryptModule, 'CertEnumCertificateContextProperties', False);
...
begin
  InitCrypt();
  if not Assigned(clCryptFindOIDInfo) then
    @clCryptFindOIDInfo := clGetProcAddress(CryptModule, 'CryptFindOIDInfo', False);

  Result := clCryptFindOIDInfo(dwKeyType, pvKey, dwGroupId);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertGetEnhancedKeyUsage) then
    @clCertGetEnhancedKeyUsage := clGetProcAddress(CryptModule, 'CertGetEnhancedKeyUsage', False);

  Result := clCertGetEnhancedKeyUsage(pCertContext, dwFlags, pUsage, pcbUsage);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertSetEnhancedKeyUsage) then
    @clCertSetEnhancedKeyUsage := clGetProcAddress(CryptModule, 'CertSetEnhancedKeyUsage', False);

  Result := clCertSetEnhancedKeyUsage(pCertContext, pUsage);
end;
