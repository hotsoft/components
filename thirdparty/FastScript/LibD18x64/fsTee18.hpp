...
// (DO NOT EDIT: machine generated header) 'fsTee18.pas' rev: 25.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSTEE18)
using namespace Fstee18;
#endif
#pragma pack(pop)
#pragma option pop
