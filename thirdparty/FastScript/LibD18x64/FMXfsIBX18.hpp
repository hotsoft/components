...
// (DO NOT EDIT: machine generated header) 'FMXfsIBX18.pas' rev: 25.00 (Windows)

#ifndef Fmxfsibx18HPP
#define Fmxfsibx18HPP
...
#include <FMX.fs_iibxrtti.hpp>	// Pascal unit
...
#include <FMX.fs_idbrtti.hpp>	// Pascal unit
...
#include <IBXMLHeader.hpp>	// Pascal unit
...
#include <IBEvents.hpp>	// Pascal unit
...
namespace Fmxfsibx18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfsibx18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSIBX18)
using namespace Fmxfsibx18;
#endif
#pragma pack(pop)
#pragma option pop
