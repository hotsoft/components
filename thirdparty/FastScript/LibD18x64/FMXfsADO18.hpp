...
// (DO NOT EDIT: machine generated header) 'FMXfsADO18.pas' rev: 25.00 (Windows)

#ifndef Fmxfsado18HPP
#define Fmxfsado18HPP
...
#include <FMX.fs_iadortti.hpp>	// Pascal unit
...
namespace Fmxfsado18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfsado18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSADO18)
using namespace Fmxfsado18;
#endif
#pragma pack(pop)
#pragma option pop
