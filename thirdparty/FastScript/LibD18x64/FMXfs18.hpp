...
// (DO NOT EDIT: machine generated header) 'FMXfs18.pas' rev: 25.00 (Windows)
...
#include <FMX.fs_ipascal.hpp>	// Pascal unit
#include <FMX.fs_icpp.hpp>	// Pascal unit
#include <FMX.fs_ijs.hpp>	// Pascal unit
#include <FMX.fs_ibasic.hpp>	// Pascal unit
#include <FMX.fs_iclassesrtti.hpp>	// Pascal unit
#include <FMX.fs_iconst.hpp>	// Pascal unit
#include <FMX.fs_idialogsrtti.hpp>	// Pascal unit
#include <FMX.fs_ievents.hpp>	// Pascal unit
#include <FMX.fs_iexpression.hpp>	// Pascal unit
#include <FMX.fs_iextctrlsrtti.hpp>	// Pascal unit
#include <FMX.fs_iformsrtti.hpp>	// Pascal unit
#include <FMX.fs_igraphicsrtti.hpp>	// Pascal unit
#include <FMX.fs_iilparser.hpp>	// Pascal unit
#include <FMX.fs_iinirtti.hpp>	// Pascal unit
#include <FMX.fs_iinterpreter.hpp>	// Pascal unit
#include <FMX.fs_iparser.hpp>	// Pascal unit
#include <FMX.fs_isysrtti.hpp>	// Pascal unit
#include <FMX.fs_imenusrtti.hpp>	// Pascal unit
#include <FMX.fs_itools.hpp>	// Pascal unit
#include <FMX.fs_xml.hpp>	// Pascal unit
#include <FMX.fs_synmemo.hpp>	// Pascal unit
#include <FMX.fs_tree.hpp>	// Pascal unit
...
#include <FMX.Messages.hpp>	// Pascal unit
#include <FMX.PixelFormats.hpp>	// Pascal unit
...
#include <Winapi.DirectDraw.hpp>	// Pascal unit
#include <Winapi.GDIPAPI.hpp>	// Pascal unit
#include <Winapi.GDIPOBJ.hpp>	// Pascal unit
#include <Winapi.GDIPUTIL.hpp>	// Pascal unit
#include <FMX.Text.hpp>	// Pascal unit
...
#include <FMX.VirtualKeyboard.hpp>	// Pascal unit
#include <FMX.Ani.hpp>	// Pascal unit
#include <FMX.InertialMovement.hpp>	// Pascal unit
#include <FMX.StdActns.hpp>	// Pascal unit
...
#include <FMX.Pickers.Default.hpp>	// Pascal unit
...
#include <FMX.Dialogs.Default.hpp>	// Pascal unit
#include <Winapi.Wincodec.hpp>	// Pascal unit
#include <Winapi.DxgiFormat.hpp>	// Pascal unit
#include <Winapi.DxgiType.hpp>	// Pascal unit
#include <Winapi.DXTypes.hpp>	// Pascal unit
#include <Winapi.DXGI.hpp>	// Pascal unit
#include <Winapi.D2D1.hpp>	// Pascal unit
#include <Winapi.D3D10.hpp>	// Pascal unit
#include <System.Win.ComConst.hpp>	// Pascal unit
#include <System.Win.ComObj.hpp>	// Pascal unit
#include <Winapi.D3D10_1.hpp>	// Pascal unit
#include <Winapi.Direct3D9.hpp>	// Pascal unit
#include <FMX.Materials.Canvas.hpp>	// Pascal unit
#include <FMX.Canvas.GPU.Helpers.hpp>	// Pascal unit
#include <FMX.FontGlyphs.Win.hpp>	// Pascal unit
#include <FMX.FontGlyphs.hpp>	// Pascal unit
#include <FMX.TextLayout.GPU.hpp>	// Pascal unit
#include <FMX.StrokeBuilder.hpp>	// Pascal unit
...
#include <FMX.Forms.Border.hpp>	// Pascal unit
#include <FMX.Forms.Border.Win.hpp>	// Pascal unit
#include <FMX.Controls.Win.hpp>	// Pascal unit
#include <FMX.Gestures.hpp>	// Pascal unit
#include <Winapi.TpcShrd.hpp>	// Pascal unit
#include <Winapi.MsInkAut.hpp>	// Pascal unit
#include <Winapi.Manipulations.hpp>	// Pascal unit
#include <Winapi.RtsCom.hpp>	// Pascal unit
#include <FMX.Gestures.Win.hpp>	// Pascal unit
#include <FMX.Platform.Win.hpp>	// Pascal unit
#include <FMX.Canvas.GDIP.hpp>	// Pascal unit
#include <FMX.Printer.Win.hpp>	// Pascal unit
...
#include <FMX.ActnList.hpp>	// Pascal unit
#include <FMX.Types.hpp>	// Pascal unit
#include <System.MaskUtils.hpp>	// Pascal unit
#include <FMX.Memo.hpp>	// Pascal unit
#include <FMX.WebBrowser.hpp>	// Pascal unit
#include <FMX.TabControl.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFS18)
using namespace Fmxfs18;
#endif
#pragma pack(pop)
#pragma option pop
