...
// (DO NOT EDIT: machine generated header) 'fsDB18.pas' rev: 25.00 (Windows)
...
#include <Vcl.VDBConsts.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSDB18)
using namespace Fsdb18;
#endif
#pragma pack(pop)
#pragma option pop
