...
// (DO NOT EDIT: machine generated header) 'FMXfsDB18.pas' rev: 25.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSDB18)
using namespace Fmxfsdb18;
#endif
#pragma pack(pop)
#pragma option pop
