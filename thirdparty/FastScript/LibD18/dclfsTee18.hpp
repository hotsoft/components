...
// (DO NOT EDIT: machine generated header) 'dclfsTee18.pas' rev: 25.00 (Windows)

#ifndef Dclfstee18HPP
#define Dclfstee18HPP
...
namespace Dclfstee18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfstee18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSTEE18)
using namespace Dclfstee18;
#endif
#pragma pack(pop)
#pragma option pop
