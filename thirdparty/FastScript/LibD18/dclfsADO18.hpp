...
// (DO NOT EDIT: machine generated header) 'dclfsADO18.pas' rev: 25.00 (Windows)

#ifndef Dclfsado18HPP
#define Dclfsado18HPP
...
namespace Dclfsado18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfsado18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSADO18)
using namespace Dclfsado18;
#endif
#pragma pack(pop)
#pragma option pop
