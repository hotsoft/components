...
// (DO NOT EDIT: machine generated header) 'fsBDE18.pas' rev: 25.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSBDE18)
using namespace Fsbde18;
#endif
#pragma pack(pop)
#pragma option pop
