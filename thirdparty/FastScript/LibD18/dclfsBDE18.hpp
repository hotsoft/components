...
// (DO NOT EDIT: machine generated header) 'dclfsBDE18.pas' rev: 25.00 (Windows)

#ifndef Dclfsbde18HPP
#define Dclfsbde18HPP
...
namespace Dclfsbde18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfsbde18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSBDE18)
using namespace Dclfsbde18;
#endif
#pragma pack(pop)
#pragma option pop
