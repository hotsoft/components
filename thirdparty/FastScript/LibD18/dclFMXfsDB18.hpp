...
// (DO NOT EDIT: machine generated header) 'dclFMXfsDB18.pas' rev: 25.00 (Windows)

#ifndef Dclfmxfsdb18HPP
#define Dclfmxfsdb18HPP
...
#include <FMXfs_idbreg.hpp>	// Pascal unit
...
namespace Dclfmxfsdb18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfsdb18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFSDB18)
using namespace Dclfmxfsdb18;
#endif
#pragma pack(pop)
#pragma option pop
