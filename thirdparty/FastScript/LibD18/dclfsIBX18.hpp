...
// (DO NOT EDIT: machine generated header) 'dclfsIBX18.pas' rev: 25.00 (Windows)

#ifndef Dclfsibx18HPP
#define Dclfsibx18HPP
...
namespace Dclfsibx18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfsibx18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSIBX18)
using namespace Dclfsibx18;
#endif
#pragma pack(pop)
#pragma option pop
