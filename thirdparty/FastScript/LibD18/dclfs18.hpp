...
// (DO NOT EDIT: machine generated header) 'dclfs18.pas' rev: 25.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFS18)
using namespace Dclfs18;
#endif
#pragma pack(pop)
#pragma option pop
