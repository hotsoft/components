...
// (DO NOT EDIT: machine generated header) 'dclFMXfs18.pas' rev: 25.00 (Windows)

#ifndef Dclfmxfs18HPP
#define Dclfmxfs18HPP
...
#include <FMXfs_ireg.hpp>	// Pascal unit
...
namespace Dclfmxfs18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfs18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFS18)
using namespace Dclfmxfs18;
#endif
#pragma pack(pop)
#pragma option pop
