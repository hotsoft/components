...
// (DO NOT EDIT: machine generated header) 'dclFMXfsADO18.pas' rev: 25.00 (Windows)

#ifndef Dclfmxfsado18HPP
#define Dclfmxfsado18HPP
...
#include <FMXfs_iadoreg.hpp>	// Pascal unit
...
namespace Dclfmxfsado18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfsado18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFSADO18)
using namespace Dclfmxfsado18;
#endif
#pragma pack(pop)
#pragma option pop
