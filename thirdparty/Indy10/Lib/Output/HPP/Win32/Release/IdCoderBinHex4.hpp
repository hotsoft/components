...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdEncoderBinHex4(System::Classes::TComponent* AOwner)/* overload */ : Idcoder3to4::TIdEncoder3to4(AOwner) { }
...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdDecoderBinHex4(System::Classes::TComponent* AOwner)/* overload */ : Idcoder3to4::TIdDecoder4to3(AOwner) { }
