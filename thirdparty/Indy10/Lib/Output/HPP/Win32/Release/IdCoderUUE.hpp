...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdDecoderUUE(System::Classes::TComponent* AOwner)/* overload */ : Idcoder00e::TIdDecoder00E(AOwner) { }
...
protected:
	virtual void __fastcall InitComponent(void);
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdEncoderUUE(System::Classes::TComponent* AOwner)/* overload */ : Idcoder00e::TIdEncoder00E(AOwner) { }
