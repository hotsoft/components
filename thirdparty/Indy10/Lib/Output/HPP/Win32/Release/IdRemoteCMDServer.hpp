...
// (DO NOT EDIT: machine generated header) 'IdRemoteCMDServer.pas' rev: 25.00 (Windows)
...
public:
	/* TIdInitializerComponent.Create */ inline __fastcall TIdRemoteCMDServer(void)/* overload */ : Idcustomtcpserver::TIdCustomTCPServer() { }
