...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdUnixTimeUDPServer(System::Classes::TComponent* AOwner)/* overload */ : Idtimeudpserver::TIdCustomTimeUDPServer(AOwner) { }
