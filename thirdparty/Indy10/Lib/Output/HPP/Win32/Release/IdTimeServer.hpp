...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdCustomTimeServer(System::Classes::TComponent* AOwner)/* overload */ : Idcustomtcpserver::TIdCustomTCPServer(AOwner) { }
...
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdTimeServer(System::Classes::TComponent* AOwner)/* overload */ : TIdCustomTimeServer(AOwner) { }
