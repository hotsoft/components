...
// (DO NOT EDIT: machine generated header) 'IdEchoUDPServer.pas' rev: 25.00 (Windows)
...
public:
	/* TIdInitializerComponent.Create */ inline __fastcall TIdEchoUDPServer(void)/* overload */ : Idudpserver::TIdUDPServer() { }
