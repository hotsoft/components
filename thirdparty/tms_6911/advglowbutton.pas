...
{$ENDIF}
  ...
  _IMAGELISTDRAWPARAMSL = packed record
    cbSize: DWORD;
    himl: HIMAGELIST;
    i: Integer;
    hdcDst: HDC;
...
function DrawVistaButton(Owner: TControl; Canvas: TCanvas; r: TRect; CFU, CTU, CFB, CTB, PC: TColor;
   ...
   Trimming: TStringTrimming;Notes: TStringList; NotesFont: TFont;Checked, Down, TranspHover, GDIPArrow: boolean; MargH,MargV: integer): TSize;
var
  graphics : TGPGraphics;
  w,h,h2,h2d: Integer;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                {$IFDEF DELPHI2007_LVL}
                if not EnabledImage and not Assigned(DisabledImages) then
                begin
  ...
  //            PenColor := BlendColor(BorderColorDown, BorderColorChecked, FStepPush);
      ...
      begin
        ...
        sz := DrawVistaButton(Self, Canvas, ClientRect, GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo,
          PenColor, GradU, GradB, DCaption, DWideCaption, FDefaultCaptionDrawing, AFont, ImgList, FDisabledImages, ImageIndex, EnabledImg, Layout, FDropDownButton {and (Style <> bsCheck)},
          ...
          FOverlappedText, FWordWrap, True, FRounded, FDropDownDirection = ddDown, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown, TranspHover and Transparent, InternalIsOnGlassQAT,MarginHorz,MarginVert);
      ...
      sz := DrawVistaButton(Self, Canvas,ClientRect,GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo,
        ...
        False, FRounded, FDropDownDirection = ddDown, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown, TranspHover and Transparent, InternalIsOnGlassQAT,MarginHorz,MarginVert);
...
begin
  ...
  Rounded := not (AStyle in [tsCustom, tsWindows8, tsOffice2013White, tsOffice2013LightGray, tsOffice2013Gray]);
  ...
  case AStyle of
    ...
    tsWhidbey:
      ...
      begin
        ...
        Appearance.ColorMirrorDownTo := clNone;
        Appearance.BorderColorDisabled := $DEDEDE;
...
begin
  ...
  with Appearance do
    Result := DrawVistaButton(Self, Canvas,ClientRect,FColor, FColorTo, FColorMirror, FColorMirrorTo,
        BorderColor, Gradient, GradientMirror, DCaption, DWideCaption, FDefaultCaptionDrawing, Font, ImgList, FDisabledImages, ImageIndex, EnabledImg, LayOt, FDropDownButton,
