...
uses
  StdCtrls, Messages, Classes, SysUtils, WinInet, Windows, Forms, system.win.Registry,
...
{$IFDEF ISDELPHI}
uses
  ActiveX, UrlMon, system.win.ComObj;
{$ENDIF}
...
begin
  ...
  begin
    ...
    if lfs = 0 then  // in case retrieving checksum fails
      lfs := fvc;
