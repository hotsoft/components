...
begin
  ...
  Application.ProcessMessages;
  hintfile := FtpOpenFile(hintconnect,PChar(fn),GENERIC_READ,FTP_TRANSFER_TYPE_BINARY or INTERNET_FLAG_RESYNCHRONIZE or INTERNET_FLAG_RELOAD or INTERNET_FLAG_DONT_CACHE,0);
