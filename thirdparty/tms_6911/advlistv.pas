...
uses
  ...
  Commctrl, Forms, PictureContainer, Dialogs, Printers, system.win.Comobj, ActiveX, Types
  {$IFDEF DELPHIXE3_LVL}
  , System.UITypes
  {$ENDIF}
  {$IFDEF TMSCODESITE}
...
const
  ...
  BLD_VER = 1; // Build nr.
  DATE_VER = 'Jan, 2013'; // Month version
...
uses
  INIFiles, Clipbrd, system.win.Registry, ShellApi, AlvUtil, RichEdit, ImgList;
    ...
    case code of
      NM_CLICK:
        begin
          ...
          SendMessage(Handle,LVM_SUBITEMHITTEST,0,integer(@lvht));
