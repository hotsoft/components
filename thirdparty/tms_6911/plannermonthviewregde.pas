...
begin
  ...
  0:begin
      ...
      MessageDlg(Component.ClassName+' version '+ (Component as TPlannerMonthView).VersionString + ' for ' + compiler + #13#10#13#10'© 2004 - 2012 by TMS software'#13#10'http://www.tmssoftware.com',
