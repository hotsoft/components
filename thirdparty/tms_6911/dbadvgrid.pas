...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        afield := DataSet.FieldByName(fld);
...
begin
{
  ...
  begin
    ...
    begin
      ...
      if not (csDesigning in ComponentState) and Assigned(SpinEdit) then
      begin
...
// DataImageField
  ...
  begin
    ...
    if Fld <> nil then
    begin
      if Fld.DataType in [ftSmallInt, ftInteger, ftWord {$IFDEF DELPHI_UNICODE}, ftByte {$ENDIF}] then
      begin
        OldActiveRecord := FDataLink.ActiveRecord;
