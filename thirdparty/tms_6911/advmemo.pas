...
const
  ...
  BLD_VER = 1; // Build nr.
  DATE_VER = 'Apr, 2013'; // Month version
...
//------------------------------------------------------------------------------
  ...
  protected
    procedure Notification(AComponent: TComponent; Operation: TOperation); override;
    procedure Loaded; override;
    function PosCommentLeft(s: string; var cl: integer): integer;
    function PosCommentRight(s: string; var cl: integer): integer;
...
uses
  ClipBrd, system.win.ComObj, ShellAPI, Math, IniFiles, ImgList, Consts, AdvMDD, ActiveX
...
begin
  ...
  begin
    i := Pos(#10, Buff);
    if i > 0 then
      Buff := StringReplace(caption, #13#10, #10, [rfReplaceAll])
  end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ll := InternalStyles.PosCommentLeft(s,cl);
          ...
          begin
            ...
            ll := InternalStyles.PosCommentRight(s,cl);
            if ll = 1 then
            begin
              comment := False;
      ...
      if (not SegmentStyle.isBracket) then
        ...
        begin
          ...
          begin
            ...
            rc := InternalStyles.PosCommentRight(s,mcrl);
          ...
          // rc := AnsiPos(InternalStyles.FLineComment, s);
            ...
            lc := InternalStyles.PosCommentLeft(s, mcll);
...
var
  ...
  begin
    ...
    begin
      //Rc := AnsiPos(InternalStyles.FMultiCommentRight, s);
      Rc := InternalStyles.PosCommentRight(s,cl);
    ...
    begin
      ...
      Mc := InternalStyles.PosCommentLeft(s,cl);
...
begin
  ...
  begin
    ...
    FStdMenu := TPopupMenu.Create(Self);
...
function TAdvCustomMemoStyler.PosCommentRight(s: string; var cl: integer): integer;
var
  res,i: integer;
begin
  res := 0;
...
function TAdvCustomMemoStyler.PosCommentLeft(s: string; var cl: integer): integer;
var
  res,i: integer;
begin
  res := 0;
  ...
  begin
    ...
    begin
      ...
      begin
        res := AnsiPos(AllStyles[i].CommentLeft, s);
        if res > 0 then
        begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if ht.X + hw > Screen.Width then
        ht.X := Screen.Width - hw;
